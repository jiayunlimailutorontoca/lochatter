...
- [2.5](protocol-2.5.md)：无新增帧。本机整理改用 Qwen，生成时逐字显示并可停止。服务端仍为 2.3.0。2.5.1 将聊天页右上角的语音通话、视频通话与助手入口移到加号面板，见 [protocol-2.5.1.md](protocol-2.5.1.md)。2.5.2 增加可选的 Qwen3.5 2B GGUF，在已打包的骁龙 Hexagon 上走 NPU，见 [protocol-2.5.2.md](protocol-2.5.2.md)。2.5.3 改为 NPU 或 GPU，不得再走 CPU，见 [protocol-2.5.3.md](protocol-2.5.3.md)。
